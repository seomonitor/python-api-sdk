...
class TopicKeywordDetail(object):
    ...
    swagger_types = {
        ...
        'search_data': 'ResearchSearchData',
        'ranking_data': 'ResearchRankingData',
        'serp_data': 'ResearchSerpData',
    ...
    def __init__(self, keyword=None, connection_strength=None, search_data=None, ranking_data=None, serp_data=None, tracked_keyword_id=None):  # noqa: E501
        """TopicKeywordDetail - a model defined in Swagger"""  # noqa: E501
        self._keyword = None
        self._connection_strength = None
        self._search_data = None
        self._ranking_data = None
        self._serp_data = None
        self._tracked_keyword_id = None
        ...
        if tracked_keyword_id is not None:
            self.tracked_keyword_id = tracked_keyword_id

    @property
    def keyword(self):
        """Gets the keyword of this TopicKeywordDetail.  # noqa: E501

        The exact keyword phrase for the returned related keyword.  # noqa: E501

        :return: The keyword of this TopicKeywordDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def keyword(self, keyword):
        """Sets the keyword of this TopicKeywordDetail.

        The exact keyword phrase for the returned related keyword.  # noqa: E501

        :param keyword: The keyword of this TopicKeywordDetail.  # noqa: E501
        :type: str
        """
    ...
    def connection_strength(self):
        """Gets the connection_strength of this TopicKeywordDetail.  # noqa: E501

        The strength of the connection between the related keyword returned and the topic specified, in a range from 1 to 5, where 5 is a very strong connection.  # noqa: E501

        :return: The connection_strength of this TopicKeywordDetail.  # noqa: E501
        :rtype: int
        """
        return self._connection_strength

    @connection_strength.setter
    def connection_strength(self, connection_strength):
        """Sets the connection_strength of this TopicKeywordDetail.

        The strength of the connection between the related keyword returned and the topic specified, in a range from 1 to 5, where 5 is a very strong connection.  # noqa: E501

        :param connection_strength: The connection_strength of this TopicKeywordDetail.  # noqa: E501
        :type: int
        """
    ...
    def search_data(self):
        """Gets the search_data of this TopicKeywordDetail.  # noqa: E501


        :return: The search_data of this TopicKeywordDetail.  # noqa: E501
        :rtype: ResearchSearchData
        """
        return self._search_data

    @search_data.setter
    def search_data(self, search_data):
        """Sets the search_data of this TopicKeywordDetail.


        :param search_data: The search_data of this TopicKeywordDetail.  # noqa: E501
        :type: ResearchSearchData
        """
    ...
    def ranking_data(self):
        """Gets the ranking_data of this TopicKeywordDetail.  # noqa: E501


        :return: The ranking_data of this TopicKeywordDetail.  # noqa: E501
        :rtype: ResearchRankingData
        """
        return self._ranking_data

    @ranking_data.setter
    def ranking_data(self, ranking_data):
        """Sets the ranking_data of this TopicKeywordDetail.


        :param ranking_data: The ranking_data of this TopicKeywordDetail.  # noqa: E501
        :type: ResearchRankingData
        """
    ...
    @property
    def serp_data(self):
        """Gets the serp_data of this TopicKeywordDetail.  # noqa: E501


        :return: The serp_data of this TopicKeywordDetail.  # noqa: E501
        :rtype: ResearchSerpData
        """
        return self._serp_data

    @serp_data.setter
    def serp_data(self, serp_data):
        """Sets the serp_data of this TopicKeywordDetail.


        :param serp_data: The serp_data of this TopicKeywordDetail.  # noqa: E501
        :type: ResearchSerpData
        """

        self._serp_data = serp_data

    @property
    def tracked_keyword_id(self):
        """Gets the tracked_keyword_id of this TopicKeywordDetail.  # noqa: E501

        The unique ID used to identify and reference the keyword in the system. Returned only if the keyword is tracked in the SEOmonitor campaign. It can be stored and used in other endpoints for filtering.  # noqa: E501

        :return: The tracked_keyword_id of this TopicKeywordDetail.  # noqa: E501
        :rtype: int
        """
        return self._tracked_keyword_id

    @tracked_keyword_id.setter
    def tracked_keyword_id(self, tracked_keyword_id):
        """Sets the tracked_keyword_id of this TopicKeywordDetail.

        The unique ID used to identify and reference the keyword in the system. Returned only if the keyword is tracked in the SEOmonitor campaign. It can be stored and used in other endpoints for filtering.  # noqa: E501

        :param tracked_keyword_id: The tracked_keyword_id of this TopicKeywordDetail.  # noqa: E501
        :type: int
        """

        self._tracked_keyword_id = tracked_keyword_id
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TopicKeywordDetail, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TopicKeywordDetail):
            return False
