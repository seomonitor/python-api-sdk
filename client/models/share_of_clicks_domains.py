...
class ShareOfClicksDomains(object):
    ...
    swagger_types = {
        'domain': 'str',
        'share_of_clicks': 'float',
        'monthly_clicks': 'int'
    }

    attribute_map = {
        'domain': 'domain',
        'share_of_clicks': 'share_of_clicks',
        'monthly_clicks': 'monthly_clicks'
    }

    def __init__(self, domain=None, share_of_clicks=None, monthly_clicks=None):  # noqa: E501
        """ShareOfClicksDomains - a model defined in Swagger"""  # noqa: E501
        self._domain = None
        self._share_of_clicks = None
        self._monthly_clicks = None
        self.discriminator = None
        if domain is not None:
            self.domain = domain
        if share_of_clicks is not None:
            self.share_of_clicks = share_of_clicks
        if monthly_clicks is not None:
            self.monthly_clicks = monthly_clicks

    @property
    def domain(self):
        """Gets the domain of this ShareOfClicksDomains.  # noqa: E501

        The domain sharing clicks with the campaign domain.  # noqa: E501

        :return: The domain of this ShareOfClicksDomains.  # noqa: E501
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this ShareOfClicksDomains.

        The domain sharing clicks with the campaign domain.  # noqa: E501

        :param domain: The domain of this ShareOfClicksDomains.  # noqa: E501
        :type: str
        """
    ...
    @property
    def share_of_clicks(self):
        """Gets the share_of_clicks of this ShareOfClicksDomains.  # noqa: E501

        The percentage of the estimated monthly share of clicks the domain receives for the current list of keywords.  # noqa: E501

        :return: The share_of_clicks of this ShareOfClicksDomains.  # noqa: E501
        :rtype: float
        """
        return self._share_of_clicks

    @share_of_clicks.setter
    def share_of_clicks(self, share_of_clicks):
        """Sets the share_of_clicks of this ShareOfClicksDomains.

        The percentage of the estimated monthly share of clicks the domain receives for the current list of keywords.  # noqa: E501

        :param share_of_clicks: The share_of_clicks of this ShareOfClicksDomains.  # noqa: E501
        :type: float
        """

        self._share_of_clicks = share_of_clicks

    @property
    def monthly_clicks(self):
        """Gets the monthly_clicks of this ShareOfClicksDomains.  # noqa: E501

        The estimated monthly clicks the domain receives for the current list of keywords.  # noqa: E501

        :return: The monthly_clicks of this ShareOfClicksDomains.  # noqa: E501
        :rtype: int
        """
        return self._monthly_clicks

    @monthly_clicks.setter
    def monthly_clicks(self, monthly_clicks):
        """Sets the monthly_clicks of this ShareOfClicksDomains.

        The estimated monthly clicks the domain receives for the current list of keywords.  # noqa: E501

        :param monthly_clicks: The monthly_clicks of this ShareOfClicksDomains.  # noqa: E501
        :type: int
        """

        self._monthly_clicks = monthly_clicks
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ShareOfClicksDomains, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShareOfClicksDomains):
            return False
