...
class ForecastAdsEquivalent(object):
    ...
    swagger_types = {
        'equivalent': 'int',
        'equivalent_best_target': 'int'
    }

    attribute_map = {
        'equivalent': 'equivalent',
        'equivalent_best_target': 'equivalent_best_target'
    }

    def __init__(self, equivalent=None, equivalent_best_target=None):  # noqa: E501
        """ForecastAdsEquivalent - a model defined in Swagger"""  # noqa: E501
        self._equivalent = None
        self._equivalent_best_target = None
        self.discriminator = None
        if equivalent is not None:
            self.equivalent = equivalent
        if equivalent_best_target is not None:
            self.equivalent_best_target = equivalent_best_target

    @property
    def equivalent(self):
        """Gets the equivalent of this ForecastAdsEquivalent.  # noqa: E501

        The equivalent estimated spend if obtaining the same additional traffic through Google Ads alone.  If the `target_rank_range` parameter returns \"true\", the `ads_equivalent` value is the value for the lower (worst) target rank.  # noqa: E501

        :return: The equivalent of this ForecastAdsEquivalent.  # noqa: E501
        :rtype: int
        """
    ...
    def equivalent(self, equivalent):
        """Sets the equivalent of this ForecastAdsEquivalent.

        The equivalent estimated spend if obtaining the same additional traffic through Google Ads alone.  If the `target_rank_range` parameter returns \"true\", the `ads_equivalent` value is the value for the lower (worst) target rank.  # noqa: E501

        :param equivalent: The equivalent of this ForecastAdsEquivalent.  # noqa: E501
        :type: int
        """
    ...
    @property
    def equivalent_best_target(self):
        """Gets the equivalent_best_target of this ForecastAdsEquivalent.  # noqa: E501

        If the `target_rank_range` parameter returns \"true\", this parameter returns the value for the higher (best) target rank.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty.   # noqa: E501

        :return: The equivalent_best_target of this ForecastAdsEquivalent.  # noqa: E501
        :rtype: int
        """
        return self._equivalent_best_target

    @equivalent_best_target.setter
    def equivalent_best_target(self, equivalent_best_target):
        """Sets the equivalent_best_target of this ForecastAdsEquivalent.

        If the `target_rank_range` parameter returns \"true\", this parameter returns the value for the higher (best) target rank.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty.   # noqa: E501

        :param equivalent_best_target: The equivalent_best_target of this ForecastAdsEquivalent.  # noqa: E501
        :type: int
        """

        self._equivalent_best_target = equivalent_best_target
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastAdsEquivalent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastAdsEquivalent):
            return False
