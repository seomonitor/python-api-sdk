...
class KeywordTrafficEcommerce(object):
    ...
    def __init__(self, transactions=None, revenue=None):  # noqa: E501
        """KeywordTrafficEcommerce - a model defined in Swagger"""  # noqa: E501
    ...
    def transactions(self):
        """Gets the transactions of this KeywordTrafficEcommerce.  # noqa: E501

        Sum of transactions uncovered from not-provided whitin the selected timeframe. Data is available only if an Analytics  profile is connected.  # noqa: E501

        :return: The transactions of this KeywordTrafficEcommerce.  # noqa: E501
        :rtype: int
        """
    ...
    def transactions(self, transactions):
        """Sets the transactions of this KeywordTrafficEcommerce.

        Sum of transactions uncovered from not-provided whitin the selected timeframe. Data is available only if an Analytics  profile is connected.  # noqa: E501

        :param transactions: The transactions of this KeywordTrafficEcommerce.  # noqa: E501
        :type: int
        """
    ...
    @property
    def revenue(self):
        """Gets the revenue of this KeywordTrafficEcommerce.  # noqa: E501

        Total ecommerce revenue uncovered through the (not provided) solution within the selected timeframe.  # noqa: E501

        :return: The revenue of this KeywordTrafficEcommerce.  # noqa: E501
        :rtype: int
        """
    ...
    def revenue(self, revenue):
        """Sets the revenue of this KeywordTrafficEcommerce.

        Total ecommerce revenue uncovered through the (not provided) solution within the selected timeframe.  # noqa: E501

        :param revenue: The revenue of this KeywordTrafficEcommerce.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KeywordTrafficEcommerce, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeywordTrafficEcommerce):
            return False
