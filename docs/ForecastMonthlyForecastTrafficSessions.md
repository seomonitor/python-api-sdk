...
------------ | ------------- | ------------- | -------------
**inertial** | **int** | The number of Inertial Sessions. | [optional] 
**additional** | **int** | The number of Additional Sessions.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this is the value calculated for the lower (worst) target rank. | [optional] 
