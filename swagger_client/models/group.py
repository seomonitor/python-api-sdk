...
class Group(object):
    ...
    def __init__(self, group_id=None, name=None, type=None, subgroups=None):  # noqa: E501
    ...
    def group_id(self):
        ...
        The unique identifier for the keyword group. It can be used to reference the group in other endpoints.  # noqa: E501
    ...
    def type(self):
        ...
        Indicates the type of group - either a regular group, a folder for organizing groups, or smart group based on rules.   Possible values are `group`, `folder`, or `smart_group`.  # noqa: E501
    ...
    @property
    def subgroups(self):
        """Gets the subgroups of this Group.  # noqa: E501

        Parent field containing subgroup objects if the group type is `folder`.   # noqa: E501

        :return: The subgroups of this Group.  # noqa: E501
        :rtype: list[Group]
        """
    ...
    def subgroups(self, subgroups):
        ...
        :param subgroups: The subgroups of this Group.  # noqa: E501
        :type: list[Group]
        """
