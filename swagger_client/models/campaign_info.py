...
class CampaignInfo(object):
    ...
    attribute_map = {
        ...
        'analytics_currency': 'analytics_currency',
        'domain': 'domain',
        'location': 'location',
        'mrr': 'mrr'
    }

    def __init__(self, id=None, name=None, company=None, company_id=None, date_created=None, keywords_count=None, campaign_currency=None, analytics_currency=None, domain=None, location=None, mrr=None):  # noqa: E501
        """CampaignInfo - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._company = None
        ...
        self._campaign_currency = None
        self._analytics_currency = None
        self._domain = None
        self._location = None
        self._mrr = None
        ...
        if campaign_currency is not None:
            self.campaign_currency = campaign_currency
        if analytics_currency is not None:
            self.analytics_currency = analytics_currency
    ...
    @property
    def id(self):
        """Gets the id of this CampaignInfo.  # noqa: E501

        The id of the campaign  # noqa: E501

        :return: The id of this CampaignInfo.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CampaignInfo.

        The id of the campaign  # noqa: E501

        :param id: The id of this CampaignInfo.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this CampaignInfo.  # noqa: E501

        The name of the campaign  # noqa: E501

        :return: The name of this CampaignInfo.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CampaignInfo.

        The name of the campaign  # noqa: E501

        :param name: The name of this CampaignInfo.  # noqa: E501
        :type: str
        """
    ...
    @property
    def company(self):
        """Gets the company of this CampaignInfo.  # noqa: E501

        The name of the company which owns the campaign  # noqa: E501

        :return: The company of this CampaignInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def company(self, company):
        """Sets the company of this CampaignInfo.

        The name of the company which owns the campaign  # noqa: E501

        :param company: The company of this CampaignInfo.  # noqa: E501
        :type: str
        """
    ...
    @property
    def company_id(self):
        """Gets the company_id of this CampaignInfo.  # noqa: E501

        The ID of the company that owns the campaign  # noqa: E501

        :return: The company_id of this CampaignInfo.  # noqa: E501
        :rtype: int
        """
    ...
    def company_id(self, company_id):
        """Sets the company_id of this CampaignInfo.

        The ID of the company that owns the campaign  # noqa: E501

        :param company_id: The company_id of this CampaignInfo.  # noqa: E501
        :type: int
        """
    ...
    def date_created(self):
        """Gets the date_created of this CampaignInfo.  # noqa: E501

        The date when the campaign was created, in YYYY-MM-DD format.  # noqa: E501

        :return: The date_created of this CampaignInfo.  # noqa: E501
        :rtype: date
        """
    ...
    def date_created(self, date_created):
        """Sets the date_created of this CampaignInfo.

        The date when the campaign was created, in YYYY-MM-DD format.  # noqa: E501

        :param date_created: The date_created of this CampaignInfo.  # noqa: E501
        :type: date
        """
    ...
    def keywords_count(self):
        """Gets the keywords_count of this CampaignInfo.  # noqa: E501

        The number of active keywords in the campaign.  # noqa: E501

        :return: The keywords_count of this CampaignInfo.  # noqa: E501
        :rtype: int
        """
    ...
    def keywords_count(self, keywords_count):
        """Sets the keywords_count of this CampaignInfo.

        The number of active keywords in the campaign.  # noqa: E501

        :param keywords_count: The keywords_count of this CampaignInfo.  # noqa: E501
        :type: int
        """
    ...
    @property
    def campaign_currency(self):
        """Gets the campaign_currency of this CampaignInfo.  # noqa: E501

        The campaign currency as configured in the campaign setup.  # noqa: E501

        :return: The campaign_currency of this CampaignInfo.  # noqa: E501
        :rtype: str
        """
        return self._campaign_currency

    @campaign_currency.setter
    def campaign_currency(self, campaign_currency):
        """Sets the campaign_currency of this CampaignInfo.

        The campaign currency as configured in the campaign setup.  # noqa: E501

        :param campaign_currency: The campaign_currency of this CampaignInfo.  # noqa: E501
        :type: str
        """
    ...
    @property
    def analytics_currency(self):
        """Gets the analytics_currency of this CampaignInfo.  # noqa: E501

        The currency pulled from the Google Analytics connection.  # noqa: E501

        :return: The analytics_currency of this CampaignInfo.  # noqa: E501
        :rtype: str
        """
        return self._analytics_currency

    @analytics_currency.setter
    def analytics_currency(self, analytics_currency):
        """Sets the analytics_currency of this CampaignInfo.

        The currency pulled from the Google Analytics connection.  # noqa: E501

        :param analytics_currency: The analytics_currency of this CampaignInfo.  # noqa: E501
        :type: str
        """

        self._analytics_currency = analytics_currency

    @property
    def domain(self):
        """Gets the domain of this CampaignInfo.  # noqa: E501

        The domain name of the website being tracked in the campaign.  # noqa: E501

        :return: The domain of this CampaignInfo.  # noqa: E501
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this CampaignInfo.

        The domain name of the website being tracked in the campaign.  # noqa: E501

        :param domain: The domain of this CampaignInfo.  # noqa: E501
        :type: str
        """
    ...
    @property
    def location(self):
        """Gets the location of this CampaignInfo.  # noqa: E501

        The location of the campaign as configured in the campaign setup.  # noqa: E501

        :return: The location of this CampaignInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def location(self, location):
        """Sets the location of this CampaignInfo.

        The location of the campaign as configured in the campaign setup.  # noqa: E501

        :param location: The location of this CampaignInfo.  # noqa: E501
        :type: str
        """
    ...
    @property
    def mrr(self):
        """Gets the mrr of this CampaignInfo.  # noqa: E501

        The value of the monthly recurring revenue (MRR) as configured in the platform.  # noqa: E501

        :return: The mrr of this CampaignInfo.  # noqa: E501
        :rtype: int
        """
        return self._mrr
    ...
    @mrr.setter
    def mrr(self, mrr):
        """Sets the mrr of this CampaignInfo.

        The value of the monthly recurring revenue (MRR) as configured in the platform.  # noqa: E501

        :param mrr: The mrr of this CampaignInfo.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CampaignInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignInfo):
            return False
