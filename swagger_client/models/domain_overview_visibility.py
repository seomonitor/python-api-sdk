...
class DomainOverviewVisibility(object):
    ...
    """
    swagger_types = {
        'my_visibility': 'DomainCompetitorVisibility',
        'competitor_visibility': 'DomainCompetitorVisibility'
    }
    ...
    def __init__(self, my_visibility=None, competitor_visibility=None):  # noqa: E501
        """DomainOverviewVisibility - a model defined in Swagger"""  # noqa: E501
        self._my_visibility = None
        self._competitor_visibility = None
        self.discriminator = None
        if my_visibility is not None:
            self.my_visibility = my_visibility
        if competitor_visibility is not None:
            self.competitor_visibility = competitor_visibility

    @property
    def my_visibility(self):
        """Gets the my_visibility of this DomainOverviewVisibility.  # noqa: E501


        :return: The my_visibility of this DomainOverviewVisibility.  # noqa: E501
        :rtype: DomainCompetitorVisibility
        """
        return self._my_visibility

    @my_visibility.setter
    def my_visibility(self, my_visibility):
        """Sets the my_visibility of this DomainOverviewVisibility.


        :param my_visibility: The my_visibility of this DomainOverviewVisibility.  # noqa: E501
        :type: DomainCompetitorVisibility
        """

        self._my_visibility = my_visibility

    @property
    def competitor_visibility(self):
        """Gets the competitor_visibility of this DomainOverviewVisibility.  # noqa: E501


        :return: The competitor_visibility of this DomainOverviewVisibility.  # noqa: E501
        :rtype: DomainCompetitorVisibility
        """
        return self._competitor_visibility

    @competitor_visibility.setter
    def competitor_visibility(self, competitor_visibility):
        """Sets the competitor_visibility of this DomainOverviewVisibility.


        :param competitor_visibility: The competitor_visibility of this DomainOverviewVisibility.  # noqa: E501
        :type: DomainCompetitorVisibility
        """

        self._competitor_visibility = competitor_visibility
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DomainOverviewVisibility, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainOverviewVisibility):
            return False
