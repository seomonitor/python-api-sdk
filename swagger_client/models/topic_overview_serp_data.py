...
class TopicOverviewSerpData(object):
    ...
    """
    swagger_types = {
        'percentage_clicks': 'int',
        'serp_features': 'list[TopicOverviewSerpFeature]'
    }
    ...
    def __init__(self, percentage_clicks=None, serp_features=None):  # noqa: E501
        """TopicOverviewSerpData - a model defined in Swagger"""  # noqa: E501
        self._percentage_clicks = None
        self._serp_features = None
    ...
    def percentage_clicks(self):
        """Gets the percentage_clicks of this TopicOverviewSerpData.  # noqa: E501

        The percentage of searches that end up clicking on organic results, based on the sum of Top 10 positions' CTRs after discounting the searches satisfied by SERP features.  # noqa: E501

        :return: The percentage_clicks of this TopicOverviewSerpData.  # noqa: E501
        :rtype: int
        """
    ...
    def percentage_clicks(self, percentage_clicks):
        """Sets the percentage_clicks of this TopicOverviewSerpData.

        The percentage of searches that end up clicking on organic results, based on the sum of Top 10 positions' CTRs after discounting the searches satisfied by SERP features.  # noqa: E501

        :param percentage_clicks: The percentage_clicks of this TopicOverviewSerpData.  # noqa: E501
        :type: int
        """
    ...
    @property
    def serp_features(self):
        """Gets the serp_features of this TopicOverviewSerpData.  # noqa: E501

        Parent field containing the top 10 SERP features present for the returned keywords and their presence count for the day of the latest crawl refreshed within the past 30 days, for desktop searches.  Please refer to the Quick Start Guide for the complete feature name of each abbreviation.   # noqa: E501

        :return: The serp_features of this TopicOverviewSerpData.  # noqa: E501
        :rtype: list[TopicOverviewSerpFeature]
        """
        return self._serp_features

    @serp_features.setter
    def serp_features(self, serp_features):
        """Sets the serp_features of this TopicOverviewSerpData.

        Parent field containing the top 10 SERP features present for the returned keywords and their presence count for the day of the latest crawl refreshed within the past 30 days, for desktop searches.  Please refer to the Quick Start Guide for the complete feature name of each abbreviation.   # noqa: E501

        :param serp_features: The serp_features of this TopicOverviewSerpData.  # noqa: E501
        :type: list[TopicOverviewSerpFeature]
        """

        self._serp_features = serp_features
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TopicOverviewSerpData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TopicOverviewSerpData):
            return False
