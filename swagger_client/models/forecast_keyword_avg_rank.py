...
class ForecastKeywordAvgRank(object):
    ...
    swagger_types = {
        ...
        'actual_rank': 'int',
        'estimated_rank': 'int',
        'estimated_rank_best_target': 'int',
        'target_rank': 'int',
        'target_rank_best': 'int'
    }
    ...
    attribute_map = {
        ...
        'estimated_rank_best_target': 'estimated_rank_best_target',
        'target_rank': 'target_rank',
        'target_rank_best': 'target_rank_best'
    }

    def __init__(self, initial_rank=None, actual_rank=None, estimated_rank=None, estimated_rank_best_target=None, target_rank=None, target_rank_best=None):  # noqa: E501
        """ForecastKeywordAvgRank - a model defined in Swagger"""  # noqa: E501
        self._initial_rank = None
        self._actual_rank = None
        self._estimated_rank = None
        self._estimated_rank_best_target = None
        self._target_rank = None
        self._target_rank_best = None
        ...
        if estimated_rank_best_target is not None:
            self.estimated_rank_best_target = estimated_rank_best_target
        if target_rank is not None:
            self.target_rank = target_rank
        if target_rank_best is not None:
            self.target_rank_best = target_rank_best

    @property
    def initial_rank(self):
        """Gets the initial_rank of this ForecastKeywordAvgRank.  # noqa: E501

        The initial rank of the keyword for the month when the scenario was created.  # noqa: E501

        :return: The initial_rank of this ForecastKeywordAvgRank.  # noqa: E501
        :rtype: int
        """
        return self._initial_rank

    @initial_rank.setter
    def initial_rank(self, initial_rank):
        """Sets the initial_rank of this ForecastKeywordAvgRank.

        The initial rank of the keyword for the month when the scenario was created.  # noqa: E501

        :param initial_rank: The initial_rank of this ForecastKeywordAvgRank.  # noqa: E501
        :type: int
        """
    ...
    def actual_rank(self):
        """Gets the actual_rank of this ForecastKeywordAvgRank.  # noqa: E501

        The latest rank of the keyword on the day the data is returned. Returns empty if the scenario is not set as an Objective.  # noqa: E501

        :return: The actual_rank of this ForecastKeywordAvgRank.  # noqa: E501
        :rtype: int
        """
        return self._actual_rank

    @actual_rank.setter
    def actual_rank(self, actual_rank):
        """Sets the actual_rank of this ForecastKeywordAvgRank.

        The latest rank of the keyword on the day the data is returned. Returns empty if the scenario is not set as an Objective.  # noqa: E501

        :param actual_rank: The actual_rank of this ForecastKeywordAvgRank.  # noqa: E501
        :type: int
        """
    ...
    def estimated_rank(self):
        """Gets the estimated_rank of this ForecastKeywordAvgRank.  # noqa: E501

        The estimated rank of the keyword for the month when the data is returned. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :return: The estimated_rank of this ForecastKeywordAvgRank.  # noqa: E501
        :rtype: int
        """
        return self._estimated_rank

    @estimated_rank.setter
    def estimated_rank(self, estimated_rank):
        """Sets the estimated_rank of this ForecastKeywordAvgRank.

        The estimated rank of the keyword for the month when the data is returned. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :param estimated_rank: The estimated_rank of this ForecastKeywordAvgRank.  # noqa: E501
        :type: int
        """

        self._estimated_rank = estimated_rank

    @property
    def estimated_rank_best_target(self):
        """Gets the estimated_rank_best_target of this ForecastKeywordAvgRank.  # noqa: E501
        ...
        :return: The estimated_rank_best_target of this ForecastKeywordAvgRank.  # noqa: E501
        :rtype: int
        """
        return self._estimated_rank_best_target

    @estimated_rank_best_target.setter
    def estimated_rank_best_target(self, estimated_rank_best_target):
        """Sets the estimated_rank_best_target of this ForecastKeywordAvgRank.

        If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.  # noqa: E501

        :param estimated_rank_best_target: The estimated_rank_best_target of this ForecastKeywordAvgRank.  # noqa: E501
        :type: int
        """

        self._estimated_rank_best_target = estimated_rank_best_target

    @property
    def target_rank(self):
        """Gets the target_rank of this ForecastKeywordAvgRank.  # noqa: E501

        The targetted rank of the keyword for the last month of the timeframe. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :return: The target_rank of this ForecastKeywordAvgRank.  # noqa: E501
        :rtype: int
        """
        return self._target_rank

    @target_rank.setter
    def target_rank(self, target_rank):
        """Sets the target_rank of this ForecastKeywordAvgRank.

        The targetted rank of the keyword for the last month of the timeframe. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :param target_rank: The target_rank of this ForecastKeywordAvgRank.  # noqa: E501
        :type: int
        """
    ...
    @property
    def target_rank_best(self):
        """Gets the target_rank_best of this ForecastKeywordAvgRank.  # noqa: E501

        If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.  # noqa: E501

        :return: The target_rank_best of this ForecastKeywordAvgRank.  # noqa: E501
        :rtype: int
        """
        return self._target_rank_best

    @target_rank_best.setter
    def target_rank_best(self, target_rank_best):
        """Sets the target_rank_best of this ForecastKeywordAvgRank.

        If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.  # noqa: E501

        :param target_rank_best: The target_rank_best of this ForecastKeywordAvgRank.  # noqa: E501
        :type: int
        """

        self._target_rank_best = target_rank_best
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastKeywordAvgRank, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastKeywordAvgRank):
            return False
