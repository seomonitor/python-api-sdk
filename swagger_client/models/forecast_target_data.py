...
class ForecastTargetData(object):
    ...
    """
    swagger_types = {
        'average_rank': 'ForecastTargetAvgRank',
        'average_visibility': 'ForecastTargetAvgVisibility'
    }
    ...
    def __init__(self, average_rank=None, average_visibility=None):  # noqa: E501
        """ForecastTargetData - a model defined in Swagger"""  # noqa: E501
        self._average_rank = None
        self._average_visibility = None
        self.discriminator = None
        if average_rank is not None:
            self.average_rank = average_rank
        if average_visibility is not None:
            self.average_visibility = average_visibility

    @property
    def average_rank(self):
        """Gets the average_rank of this ForecastTargetData.  # noqa: E501


        :return: The average_rank of this ForecastTargetData.  # noqa: E501
        :rtype: ForecastTargetAvgRank
        """
        return self._average_rank

    @average_rank.setter
    def average_rank(self, average_rank):
        """Sets the average_rank of this ForecastTargetData.


        :param average_rank: The average_rank of this ForecastTargetData.  # noqa: E501
        :type: ForecastTargetAvgRank
        """

        self._average_rank = average_rank

    @property
    def average_visibility(self):
        """Gets the average_visibility of this ForecastTargetData.  # noqa: E501


        :return: The average_visibility of this ForecastTargetData.  # noqa: E501
        :rtype: ForecastTargetAvgVisibility
        """
        return self._average_visibility

    @average_visibility.setter
    def average_visibility(self, average_visibility):
        """Sets the average_visibility of this ForecastTargetData.


        :param average_visibility: The average_visibility of this ForecastTargetData.  # noqa: E501
        :type: ForecastTargetAvgVisibility
        """

        self._average_visibility = average_visibility
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastTargetData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastTargetData):
            return False
