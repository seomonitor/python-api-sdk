...
class ForecastOverviewData(object):
    ...
    """
    swagger_types = {
        'additional_traffic': 'ForecastAdditionalTraffic',
        'inertial_traffic': 'ForecastOverviewInertialTraffic',
        'ads_equivalent': 'ForecastAdsEquivalent'
    }

    attribute_map = {
        'additional_traffic': 'additional_traffic',
        'inertial_traffic': 'inertial_traffic',
        'ads_equivalent': 'ads_equivalent'
    }

    def __init__(self, additional_traffic=None, inertial_traffic=None, ads_equivalent=None):  # noqa: E501
        """ForecastOverviewData - a model defined in Swagger"""  # noqa: E501
        self._additional_traffic = None
        self._inertial_traffic = None
        self._ads_equivalent = None
        self.discriminator = None
        if additional_traffic is not None:
            self.additional_traffic = additional_traffic
        if inertial_traffic is not None:
            self.inertial_traffic = inertial_traffic
        if ads_equivalent is not None:
            self.ads_equivalent = ads_equivalent

    @property
    def additional_traffic(self):
        """Gets the additional_traffic of this ForecastOverviewData.  # noqa: E501


        :return: The additional_traffic of this ForecastOverviewData.  # noqa: E501
        :rtype: ForecastAdditionalTraffic
        """
        return self._additional_traffic

    @additional_traffic.setter
    def additional_traffic(self, additional_traffic):
        """Sets the additional_traffic of this ForecastOverviewData.


        :param additional_traffic: The additional_traffic of this ForecastOverviewData.  # noqa: E501
        :type: ForecastAdditionalTraffic
        """

        self._additional_traffic = additional_traffic

    @property
    def inertial_traffic(self):
        """Gets the inertial_traffic of this ForecastOverviewData.  # noqa: E501


        :return: The inertial_traffic of this ForecastOverviewData.  # noqa: E501
        :rtype: ForecastOverviewInertialTraffic
        """
        return self._inertial_traffic

    @inertial_traffic.setter
    def inertial_traffic(self, inertial_traffic):
        """Sets the inertial_traffic of this ForecastOverviewData.


        :param inertial_traffic: The inertial_traffic of this ForecastOverviewData.  # noqa: E501
        :type: ForecastOverviewInertialTraffic
        """

        self._inertial_traffic = inertial_traffic

    @property
    def ads_equivalent(self):
        """Gets the ads_equivalent of this ForecastOverviewData.  # noqa: E501


        :return: The ads_equivalent of this ForecastOverviewData.  # noqa: E501
        :rtype: ForecastAdsEquivalent
        """
        return self._ads_equivalent

    @ads_equivalent.setter
    def ads_equivalent(self, ads_equivalent):
        """Sets the ads_equivalent of this ForecastOverviewData.


        :param ads_equivalent: The ads_equivalent of this ForecastOverviewData.  # noqa: E501
        :type: ForecastAdsEquivalent
        """

        self._ads_equivalent = ads_equivalent
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastOverviewData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastOverviewData):
            return False
