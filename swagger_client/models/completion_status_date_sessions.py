...
class CompletionStatusDateSessions(object):
    ...
    swagger_types = {
        'actual_sessions': 'int',
        'forecasted_sessions': 'int'
    }

    attribute_map = {
        'actual_sessions': 'actual_sessions',
        'forecasted_sessions': 'forecasted_sessions'
    }

    def __init__(self, actual_sessions=None, forecasted_sessions=None):  # noqa: E501
        """CompletionStatusDateSessions - a model defined in Swagger"""  # noqa: E501
        self._actual_sessions = None
        self._forecasted_sessions = None
        self.discriminator = None
        if actual_sessions is not None:
            self.actual_sessions = actual_sessions
        if forecasted_sessions is not None:
            self.forecasted_sessions = forecasted_sessions

    @property
    def actual_sessions(self):
        """Gets the actual_sessions of this CompletionStatusDateSessions.  # noqa: E501

        The number of sessions recorded from the start of the forecast to the current date.  # noqa: E501

        :return: The actual_sessions of this CompletionStatusDateSessions.  # noqa: E501
        :rtype: int
        """
    ...
    def actual_sessions(self, actual_sessions):
        """Sets the actual_sessions of this CompletionStatusDateSessions.

        The number of sessions recorded from the start of the forecast to the current date.  # noqa: E501

        :param actual_sessions: The actual_sessions of this CompletionStatusDateSessions.  # noqa: E501
        :type: int
        """
    ...
    @property
    def forecasted_sessions(self):
        """Gets the forecasted_sessions of this CompletionStatusDateSessions.  # noqa: E501

        The number of sessions estimated to be obtained from the start of the forecast to the current date.  # noqa: E501

        :return: The forecasted_sessions of this CompletionStatusDateSessions.  # noqa: E501
        :rtype: int
        """
        return self._forecasted_sessions

    @forecasted_sessions.setter
    def forecasted_sessions(self, forecasted_sessions):
        """Sets the forecasted_sessions of this CompletionStatusDateSessions.

        The number of sessions estimated to be obtained from the start of the forecast to the current date.  # noqa: E501

        :param forecasted_sessions: The forecasted_sessions of this CompletionStatusDateSessions.  # noqa: E501
        :type: int
        """

        self._forecasted_sessions = forecasted_sessions
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CompletionStatusDateSessions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompletionStatusDateSessions):
            return False
