...
class GscData(object):
    ...
    def __init__(self, impressions=None, clicks=None, avg_position=None):  # noqa: E501
        """GscData - a model defined in Swagger"""  # noqa: E501
    ...
    def impressions(self):
        """Gets the impressions of this GscData.  # noqa: E501

        The total number of impressions in Google search results for the specified keyword over the specified timeframe.  # noqa: E501

        :return: The impressions of this GscData.  # noqa: E501
        :rtype: int
        """
    ...
    def impressions(self, impressions):
        """Sets the impressions of this GscData.

        The total number of impressions in Google search results for the specified keyword over the specified timeframe.  # noqa: E501

        :param impressions: The impressions of this GscData.  # noqa: E501
        :type: int
        """
    ...
    @property
    def clicks(self):
        """Gets the clicks of this GscData.  # noqa: E501

        The total number of clicks that the keyword received in Google search results over the specified timeframe.  # noqa: E501

        :return: The clicks of this GscData.  # noqa: E501
        :rtype: int
        """
        return self._clicks
    ...
    def clicks(self, clicks):
        """Sets the clicks of this GscData.

        The total number of clicks that the keyword received in Google search results over the specified timeframe.  # noqa: E501

        :param clicks: The clicks of this GscData.  # noqa: E501
        :type: int
        """
    ...
    def avg_position(self):
        """Gets the avg_position of this GscData.  # noqa: E501

        The keyword's average position on Google over the specified timeframe, blended for desktop and mobile devices.  # noqa: E501

        :return: The avg_position of this GscData.  # noqa: E501
        :rtype: int
        """
    ...
    def avg_position(self, avg_position):
        """Sets the avg_position of this GscData.

        The keyword's average position on Google over the specified timeframe, blended for desktop and mobile devices.  # noqa: E501

        :param avg_position: The avg_position of this GscData.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GscData):
            return False
