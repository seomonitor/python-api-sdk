...
class ForecastTargetAvgRank(object):
    ...
    def __init__(self, initial_rank=None, trend_3months=None, target_rank=None, best_target_rank=None):  # noqa: E501
        """ForecastTargetAvgRank - a model defined in Swagger"""  # noqa: E501
        self._initial_rank = None
        self._trend_3months = None
        self._target_rank = None
        self._best_target_rank = None
        ...
        if best_target_rank is not None:
            self.best_target_rank = best_target_rank

    @property
    def initial_rank(self):
        """Gets the initial_rank of this ForecastTargetAvgRank.  # noqa: E501

        The average initial rank of the keywords included in the scenario, calculated for the month when the scenario was created.  # noqa: E501

        :return: The initial_rank of this ForecastTargetAvgRank.  # noqa: E501
        :rtype: int
        """
    ...
    def initial_rank(self, initial_rank):
        """Sets the initial_rank of this ForecastTargetAvgRank.

        The average initial rank of the keywords included in the scenario, calculated for the month when the scenario was created.  # noqa: E501

        :param initial_rank: The initial_rank of this ForecastTargetAvgRank.  # noqa: E501
        :type: int
        """
    ...
    def trend_3months(self):
        """Gets the trend_3months of this ForecastTargetAvgRank.  # noqa: E501

        The average increase or drop in positions of the keywords in the scenario, over the previous 3 months up to the month the scenario was created, weighted by the keywords' search volume.  # noqa: E501

        :return: The trend_3months of this ForecastTargetAvgRank.  # noqa: E501
        :rtype: int
        """
    ...
    def trend_3months(self, trend_3months):
        """Sets the trend_3months of this ForecastTargetAvgRank.

        The average increase or drop in positions of the keywords in the scenario, over the previous 3 months up to the month the scenario was created, weighted by the keywords' search volume.  # noqa: E501

        :param trend_3months: The trend_3months of this ForecastTargetAvgRank.  # noqa: E501
        :type: int
        """
    ...
    def target_rank(self):
        """Gets the target_rank of this ForecastTargetAvgRank.  # noqa: E501

        The average target rank of the keywords in the Objective. If the `target_rank_range` parameter returns \"true\", the `target_rank` is the lower (worst) average target rank.  # noqa: E501

        :return: The target_rank of this ForecastTargetAvgRank.  # noqa: E501
        :rtype: int
        """
    ...
    def target_rank(self, target_rank):
        """Sets the target_rank of this ForecastTargetAvgRank.

        The average target rank of the keywords in the Objective. If the `target_rank_range` parameter returns \"true\", the `target_rank` is the lower (worst) average target rank.  # noqa: E501

        :param target_rank: The target_rank of this ForecastTargetAvgRank.  # noqa: E501
        :type: int
        """
    ...
    @property
    def best_target_rank(self):
        """Gets the best_target_rank of this ForecastTargetAvgRank.  # noqa: E501

        If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) average target rank. If the `target_rank_range` parameter returns \"false\", this parameter will return empty.  # noqa: E501

        :return: The best_target_rank of this ForecastTargetAvgRank.  # noqa: E501
        :rtype: int
        """
        return self._best_target_rank

    @best_target_rank.setter
    def best_target_rank(self, best_target_rank):
        """Sets the best_target_rank of this ForecastTargetAvgRank.

        If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) average target rank. If the `target_rank_range` parameter returns \"false\", this parameter will return empty.  # noqa: E501

        :param best_target_rank: The best_target_rank of this ForecastTargetAvgRank.  # noqa: E501
        :type: int
        """

        self._best_target_rank = best_target_rank
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastTargetAvgRank, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastTargetAvgRank):
            return False
