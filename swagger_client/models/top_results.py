...
class TopResults(object):
    ...
    swagger_types = {
        'keyword_id': 'int',
        'keyword': 'str',
        'top_100_results': 'list[Top100Results]'
    }

    attribute_map = {
        'keyword_id': 'keyword_id',
        'keyword': 'keyword',
        'top_100_results': 'top_100_results'
    }

    def __init__(self, keyword_id=None, keyword=None, top_100_results=None):  # noqa: E501
        """TopResults - a model defined in Swagger"""  # noqa: E501
        self._keyword_id = None
        self._keyword = None
        self._top_100_results = None
        self.discriminator = None
        if keyword_id is not None:
            self.keyword_id = keyword_id
        if keyword is not None:
            self.keyword = keyword
        if top_100_results is not None:
            self.top_100_results = top_100_results

    @property
    def keyword_id(self):
        """Gets the keyword_id of this TopResults.  # noqa: E501

        The unique ID used to identify and reference the keyword in the SEOmonitor system.   # noqa: E501

        :return: The keyword_id of this TopResults.  # noqa: E501
        :rtype: int
        """
    ...
    def keyword_id(self, keyword_id):
        """Sets the keyword_id of this TopResults.

        The unique ID used to identify and reference the keyword in the SEOmonitor system.   # noqa: E501

        :param keyword_id: The keyword_id of this TopResults.  # noqa: E501
        :type: int
        """
    ...
    @property
    def keyword(self):
        """Gets the keyword of this TopResults.  # noqa: E501

        The exact keyword phrase.  # noqa: E501

        :return: The keyword of this TopResults.  # noqa: E501
        :rtype: str
        """
    ...
    def keyword(self, keyword):
        """Sets the keyword of this TopResults.

        The exact keyword phrase.  # noqa: E501

        :param keyword: The keyword of this TopResults.  # noqa: E501
        :type: str
        """
    ...
    @property
    def top_100_results(self):
        """Gets the top_100_results of this TopResults.  # noqa: E501

        Parent field containing keyword ranking data for the competitors selected in the SEOmonitor platform, comprising of their domain, the ranking landing page for the keyword, and ranking data.  # noqa: E501

        :return: The top_100_results of this TopResults.  # noqa: E501
        :rtype: list[Top100Results]
        """
        return self._top_100_results

    @top_100_results.setter
    def top_100_results(self, top_100_results):
        """Sets the top_100_results of this TopResults.

        Parent field containing keyword ranking data for the competitors selected in the SEOmonitor platform, comprising of their domain, the ranking landing page for the keyword, and ranking data.  # noqa: E501

        :param top_100_results: The top_100_results of this TopResults.  # noqa: E501
        :type: list[Top100Results]
        """

        self._top_100_results = top_100_results
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TopResults):
            return False
