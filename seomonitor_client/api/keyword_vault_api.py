...
class KeywordVaultApi(object):
    ...
    def keyword_vault_v30_get_keyword_data_by_list_get(self, campaign_id, list, **kwargs):  # noqa: E501
        """Get Keyword Data by List  # noqa: E501

        This endpoint returns the SERP, search and ranking data for the keywords in a specified list within the Keyword Vault of a specified campaign. The ranking data is for both the website tracked in the specified SEOmonitor campaign and for the specified competitor websites.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.keyword_vault_v30_get_keyword_data_by_list_get(campaign_id, list, async_req=True)
        >>> result = thread.get()
        ...
        :param str list: The name of the list created in the Keyword Vault for which you want to return keyword data. (required)
        ...
        :param str order_by: This parameter enables you to sort the returned data based on a specified field.  The field names you can use to sort data are:  `search_volume`  `year-over-year`  `rank`  `rank_trend`  `percentage_clicks`  If not otherwise specified, the returned data will be sorted by `connection_strength` by default.
        ...
        if kwargs.get('async_req'):
            return self.keyword_vault_v30_get_keyword_data_by_list_get_with_http_info(campaign_id, list, **kwargs)  # noqa: E501
        else:
            (data) = self.keyword_vault_v30_get_keyword_data_by_list_get_with_http_info(campaign_id, list, **kwargs)  # noqa: E501
            return data

    def keyword_vault_v30_get_keyword_data_by_list_get_with_http_info(self, campaign_id, list, **kwargs):  # noqa: E501
        """Get Keyword Data by List  # noqa: E501

        This endpoint returns the SERP, search and ranking data for the keywords in a specified list within the Keyword Vault of a specified campaign. The ranking data is for both the website tracked in the specified SEOmonitor campaign and for the specified competitor websites.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.keyword_vault_v30_get_keyword_data_by_list_get_with_http_info(campaign_id, list, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['campaign_id', 'list', 'limit', 'offset', 'order_by', 'order_direction', 'search']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method keyword_vault_v30_get_keyword_data_by_list_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('campaign_id' not in params or
            ...
            raise ValueError("Missing the required parameter `campaign_id` when calling `keyword_vault_v30_get_keyword_data_by_list_get`")  # noqa: E501
        # verify the required parameter 'list' is set
        if ('list' not in params or
                params['list'] is None):
            raise ValueError("Missing the required parameter `list` when calling `keyword_vault_v30_get_keyword_data_by_list_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/keyword-vault/v3.0/get-keyword-data-by-list', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='KeywordVaultGetKeywordDataByList',  # noqa: E501
    ...
    def keyword_vault_v30_get_overview_data_get(self, campaign_id, list, **kwargs):  # noqa: E501
        """Get Overview Data  # noqa: E501

        This endpoint returns the overall aggregated search, SERP, and Visibility data for all the keywords of a specified list in the Keyword Vault.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.keyword_vault_v30_get_overview_data_get(campaign_id, list, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.keyword_vault_v30_get_overview_data_get_with_http_info(campaign_id, list, **kwargs)  # noqa: E501
        else:
            (data) = self.keyword_vault_v30_get_overview_data_get_with_http_info(campaign_id, list, **kwargs)  # noqa: E501
            return data

    def keyword_vault_v30_get_overview_data_get_with_http_info(self, campaign_id, list, **kwargs):  # noqa: E501
        """Get Overview Data  # noqa: E501

        This endpoint returns the overall aggregated search, SERP, and Visibility data for all the keywords of a specified list in the Keyword Vault.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.keyword_vault_v30_get_overview_data_get_with_http_info(campaign_id, list, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['campaign_id', 'list']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method keyword_vault_v30_get_overview_data_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'campaign_id' is set
        if ('campaign_id' not in params or
                params['campaign_id'] is None):
            raise ValueError("Missing the required parameter `campaign_id` when calling `keyword_vault_v30_get_overview_data_get`")  # noqa: E501
        # verify the required parameter 'list' is set
        if ('list' not in params or
                params['list'] is None):
            raise ValueError("Missing the required parameter `list` when calling `keyword_vault_v30_get_overview_data_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/keyword-vault/v3.0/get-overview-data', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='KeywordVaultGetOverviewData',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
