...
class ForecastApi(object):
    ...
    def forecast_v30_keywords_get(self, campaign_id, forecast_id, **kwargs):  # noqa: E501
        """Get Forecast keywords  # noqa: E501

        This endpoint returns the forecast data for the keywords included in the Forecast Scenario or Objective, including keyword data, target rank data, and additional traffic data, for the forecast timeframe.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forecast_v30_keywords_get(campaign_id, forecast_id, async_req=True)
        >>> result = thread.get()
        ...
        :param int forecast_id: This parameter specifies the ID of the Forecast scenario set as an Objective for which you want to return data.   Please refer to the 'Quick Start Guide'  to retrieve the ID of your scenarios.  (required)
        ...
        if kwargs.get('async_req'):
            return self.forecast_v30_keywords_get_with_http_info(campaign_id, forecast_id, **kwargs)  # noqa: E501
        else:
            (data) = self.forecast_v30_keywords_get_with_http_info(campaign_id, forecast_id, **kwargs)  # noqa: E501
            return data

    def forecast_v30_keywords_get_with_http_info(self, campaign_id, forecast_id, **kwargs):  # noqa: E501
        """Get Forecast keywords  # noqa: E501

        This endpoint returns the forecast data for the keywords included in the Forecast Scenario or Objective, including keyword data, target rank data, and additional traffic data, for the forecast timeframe.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forecast_v30_keywords_get_with_http_info(campaign_id, forecast_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['campaign_id', 'forecast_id', 'limit', 'offset']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method forecast_v30_keywords_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('campaign_id' not in params or
            ...
            raise ValueError("Missing the required parameter `campaign_id` when calling `forecast_v30_keywords_get`")  # noqa: E501
        # verify the required parameter 'forecast_id' is set
        if ('forecast_id' not in params or
                params['forecast_id'] is None):
            raise ValueError("Missing the required parameter `forecast_id` when calling `forecast_v30_keywords_get`")  # noqa: E501
        ...
        if 'forecast_id' in params:
            query_params.append(('forecast_id', params['forecast_id']))  # noqa: E501
        if 'limit' in params:
        ...
        return self.api_client.call_api(
            ...
            response_type='list[ForecastKeywords]',  # noqa: E501
    ...
    def forecast_v30_objective_get(self, campaign_id, forecast_id, **kwargs):  # noqa: E501
        """Get Forecast objective Data  # noqa: E501

        This endpoint returns the data of Forecast Scenarios set as Objectives, including the SEO goal and configuration parameters, the forecast results overview data, and the monthly actual and estimated results for the forecast timeframe.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forecast_v30_objective_get(campaign_id, forecast_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int campaign_id: This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
        :param int forecast_id: This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.forecast_v30_objective_get_with_http_info(campaign_id, forecast_id, **kwargs)  # noqa: E501
        else:
            (data) = self.forecast_v30_objective_get_with_http_info(campaign_id, forecast_id, **kwargs)  # noqa: E501
            return data

    def forecast_v30_objective_get_with_http_info(self, campaign_id, forecast_id, **kwargs):  # noqa: E501
        """Get Forecast objective Data  # noqa: E501

        This endpoint returns the data of Forecast Scenarios set as Objectives, including the SEO goal and configuration parameters, the forecast results overview data, and the monthly actual and estimated results for the forecast timeframe.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forecast_v30_objective_get_with_http_info(campaign_id, forecast_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['campaign_id', 'forecast_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method forecast_v30_objective_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'campaign_id' is set
        if ('campaign_id' not in params or
                params['campaign_id'] is None):
            raise ValueError("Missing the required parameter `campaign_id` when calling `forecast_v30_objective_get`")  # noqa: E501
        # verify the required parameter 'forecast_id' is set
        if ('forecast_id' not in params or
                params['forecast_id'] is None):
            raise ValueError("Missing the required parameter `forecast_id` when calling `forecast_v30_objective_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ForecastObjectiveData',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def forecast_v30_scenario_get(self, campaign_id, forecast_id, **kwargs):  # noqa: E501
        """Get Forecast scenario Data  # noqa: E501

        This endpoint returns the data of Forecast Scenarios created in a specified campaign, including the scenario details, the SEO goal and configuration parameters, the forecast results overview data, and the monthly estimated results for the forecast timeframe.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forecast_v30_scenario_get(campaign_id, forecast_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int campaign_id: This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
        :param int forecast_id: This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  To get data for the Campaign Objective, use the 'Get Forecast Objective Data'.  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.forecast_v30_scenario_get_with_http_info(campaign_id, forecast_id, **kwargs)  # noqa: E501
        else:
            (data) = self.forecast_v30_scenario_get_with_http_info(campaign_id, forecast_id, **kwargs)  # noqa: E501
            return data

    def forecast_v30_scenario_get_with_http_info(self, campaign_id, forecast_id, **kwargs):  # noqa: E501
        """Get Forecast scenario Data  # noqa: E501

        This endpoint returns the data of Forecast Scenarios created in a specified campaign, including the scenario details, the SEO goal and configuration parameters, the forecast results overview data, and the monthly estimated results for the forecast timeframe.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forecast_v30_scenario_get_with_http_info(campaign_id, forecast_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method forecast_v30_scenario_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'campaign_id' is set
        if ('campaign_id' not in params or
                params['campaign_id'] is None):
            raise ValueError("Missing the required parameter `campaign_id` when calling `forecast_v30_scenario_get`")  # noqa: E501
        # verify the required parameter 'forecast_id' is set
        if ('forecast_id' not in params or
                params['forecast_id'] is None):
            raise ValueError("Missing the required parameter `forecast_id` when calling `forecast_v30_scenario_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ForecastScenarioData',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def forecast_v30_scenarios_get(self, campaign_id, **kwargs):  # noqa: E501
        """Get Forecast scenarios  # noqa: E501

        This endpoint returns a list of Scenarios created in a specified campaign, including the Objective if one is set, and their details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forecast_v30_scenarios_get(campaign_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.forecast_v30_scenarios_get_with_http_info(campaign_id, **kwargs)  # noqa: E501
        else:
            (data) = self.forecast_v30_scenarios_get_with_http_info(campaign_id, **kwargs)  # noqa: E501
            return data

    def forecast_v30_scenarios_get_with_http_info(self, campaign_id, **kwargs):  # noqa: E501
        """Get Forecast scenarios  # noqa: E501

        This endpoint returns a list of Scenarios created in a specified campaign, including the Objective if one is set, and their details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forecast_v30_scenarios_get_with_http_info(campaign_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method forecast_v30_scenarios_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'campaign_id' is set
        if ('campaign_id' not in params or
                params['campaign_id'] is None):
            raise ValueError("Missing the required parameter `campaign_id` when calling `forecast_v30_scenarios_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='Scenarios',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
