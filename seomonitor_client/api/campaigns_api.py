...
class CampaignsApi(object):
    ...
    def dashboard_v30_campaigns_tracked_get(self, **kwargs):  # noqa: E501
        """Get Tracked Campaigns  # noqa: E501

        This endpoint returns a list of active Tracked Campaigns with their details, such as campaign_id, name, URL, keyword number, date created, account manager details, and Visibility data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dashboard_v30_campaigns_tracked_get(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str campaign_ids: The Tracked Campaigns IDs for which you want the data to be returned.  Please refer to the Quick Start Guide to learn how to retrieve your campaign IDs.  If you do not specify `campaign_ids`, the endpoint will return the data for all active Tracked Campaigns you have access to, across all company accounts.
        :param int company_id: The ID of the subscription that contains the Tracked Campaigns for which you want to return data. This is useful for users who have access to multiple company accounts.  Please refer to the Quick Start Guide to learn how to retrieve your company IDs.  If you don't specify a `company_id`, the endpoint will return the data for all Tracked Campaigns you have access to, across all company accounts.
        :param int limit: The maximum number of Tracked Campaigns to return data for.   Maximum Value: 100 records per request  If you do not specify a `limit`, the default number of records returned per request will be 10.
        ...
        if kwargs.get('async_req'):
            return self.dashboard_v30_campaigns_tracked_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.dashboard_v30_campaigns_tracked_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def dashboard_v30_campaigns_tracked_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get Tracked Campaigns  # noqa: E501

        This endpoint returns a list of active Tracked Campaigns with their details, such as campaign_id, name, URL, keyword number, date created, account manager details, and Visibility data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dashboard_v30_campaigns_tracked_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['campaign_ids', 'company_id', 'limit', 'offset']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method dashboard_v30_campaigns_tracked_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/dashboard/v3.0/campaigns/tracked', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='list[CampaignDetailsRegular]',  # noqa: E501
