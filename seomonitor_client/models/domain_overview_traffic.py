...
class DomainOverviewTraffic(object):
    ...
    """
    swagger_types = {
        'my_traffic': 'OverviewTrafficData',
        'competitor_traffic': 'OverviewTrafficData'
    }
    ...
    def __init__(self, my_traffic=None, competitor_traffic=None):  # noqa: E501
        """DomainOverviewTraffic - a model defined in Swagger"""  # noqa: E501
        self._my_traffic = None
        self._competitor_traffic = None
        self.discriminator = None
        if my_traffic is not None:
            self.my_traffic = my_traffic
        if competitor_traffic is not None:
            self.competitor_traffic = competitor_traffic

    @property
    def my_traffic(self):
        """Gets the my_traffic of this DomainOverviewTraffic.  # noqa: E501


        :return: The my_traffic of this DomainOverviewTraffic.  # noqa: E501
        :rtype: OverviewTrafficData
        """
        return self._my_traffic

    @my_traffic.setter
    def my_traffic(self, my_traffic):
        """Sets the my_traffic of this DomainOverviewTraffic.


        :param my_traffic: The my_traffic of this DomainOverviewTraffic.  # noqa: E501
        :type: OverviewTrafficData
        """

        self._my_traffic = my_traffic

    @property
    def competitor_traffic(self):
        """Gets the competitor_traffic of this DomainOverviewTraffic.  # noqa: E501


        :return: The competitor_traffic of this DomainOverviewTraffic.  # noqa: E501
        :rtype: OverviewTrafficData
        """
        return self._competitor_traffic

    @competitor_traffic.setter
    def competitor_traffic(self, competitor_traffic):
        """Sets the competitor_traffic of this DomainOverviewTraffic.


        :param competitor_traffic: The competitor_traffic of this DomainOverviewTraffic.  # noqa: E501
        :type: OverviewTrafficData
        """

        self._competitor_traffic = competitor_traffic
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DomainOverviewTraffic, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainOverviewTraffic):
            return False
