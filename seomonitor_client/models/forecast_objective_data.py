...
class ForecastObjectiveData(object):
    ...
    """
    swagger_types = {
        'objective_data': 'ForecastObjectiveDetails',
        'seo_goal': 'ForecastSeoGoal',
        'scenario_configuration': 'ForecastConfiguration',
        'overview_data': 'ForecastOverviewData',
        'monthly_forecast': 'ForecastMonthlyForecasts',
        'monthly_forecast_extended': 'ForecastMonthlyForecasts'
    }
    ...
    attribute_map = {
        ...
        'monthly_forecast_extended': 'monthly_forecast_extended'
    }

    def __init__(self, objective_data=None, seo_goal=None, scenario_configuration=None, overview_data=None, monthly_forecast=None, monthly_forecast_extended=None):  # noqa: E501
        """ForecastObjectiveData - a model defined in Swagger"""  # noqa: E501
        self._objective_data = None
        self._seo_goal = None
        self._scenario_configuration = None
        self._overview_data = None
        self._monthly_forecast = None
        self._monthly_forecast_extended = None
        self.discriminator = None
        if objective_data is not None:
            self.objective_data = objective_data
        if seo_goal is not None:
            self.seo_goal = seo_goal
        ...
        if monthly_forecast is not None:
            self.monthly_forecast = monthly_forecast
        if monthly_forecast_extended is not None:
            self.monthly_forecast_extended = monthly_forecast_extended

    @property
    def objective_data(self):
        """Gets the objective_data of this ForecastObjectiveData.  # noqa: E501


        :return: The objective_data of this ForecastObjectiveData.  # noqa: E501
        :rtype: ForecastObjectiveDetails
        """
        return self._objective_data

    @objective_data.setter
    def objective_data(self, objective_data):
        """Sets the objective_data of this ForecastObjectiveData.


        :param objective_data: The objective_data of this ForecastObjectiveData.  # noqa: E501
        :type: ForecastObjectiveDetails
        """
    ...
    @property
    def seo_goal(self):
        """Gets the seo_goal of this ForecastObjectiveData.  # noqa: E501


        :return: The seo_goal of this ForecastObjectiveData.  # noqa: E501
        :rtype: ForecastSeoGoal
        """
        return self._seo_goal

    @seo_goal.setter
    def seo_goal(self, seo_goal):
        """Sets the seo_goal of this ForecastObjectiveData.


        :param seo_goal: The seo_goal of this ForecastObjectiveData.  # noqa: E501
        :type: ForecastSeoGoal
        """

        self._seo_goal = seo_goal

    @property
    def scenario_configuration(self):
        """Gets the scenario_configuration of this ForecastObjectiveData.  # noqa: E501


        :return: The scenario_configuration of this ForecastObjectiveData.  # noqa: E501
    ...
    def scenario_configuration(self, scenario_configuration):
        """Sets the scenario_configuration of this ForecastObjectiveData.


        :param scenario_configuration: The scenario_configuration of this ForecastObjectiveData.  # noqa: E501
    ...
    def overview_data(self):
        """Gets the overview_data of this ForecastObjectiveData.  # noqa: E501


        :return: The overview_data of this ForecastObjectiveData.  # noqa: E501
        :rtype: ForecastOverviewData
        """
        return self._overview_data

    @overview_data.setter
    def overview_data(self, overview_data):
        """Sets the overview_data of this ForecastObjectiveData.


        :param overview_data: The overview_data of this ForecastObjectiveData.  # noqa: E501
        :type: ForecastOverviewData
        """
    ...
    def monthly_forecast(self):
        """Gets the monthly_forecast of this ForecastObjectiveData.  # noqa: E501


        :return: The monthly_forecast of this ForecastObjectiveData.  # noqa: E501
        :rtype: ForecastMonthlyForecasts
        """
        return self._monthly_forecast

    @monthly_forecast.setter
    def monthly_forecast(self, monthly_forecast):
        """Sets the monthly_forecast of this ForecastObjectiveData.


        :param monthly_forecast: The monthly_forecast of this ForecastObjectiveData.  # noqa: E501
        :type: ForecastMonthlyForecasts
        """

        self._monthly_forecast = monthly_forecast

    @property
    def monthly_forecast_extended(self):
        """Gets the monthly_forecast_extended of this ForecastObjectiveData.  # noqa: E501


        :return: The monthly_forecast_extended of this ForecastObjectiveData.  # noqa: E501
        :rtype: ForecastMonthlyForecasts
        """
        return self._monthly_forecast_extended

    @monthly_forecast_extended.setter
    def monthly_forecast_extended(self, monthly_forecast_extended):
        """Sets the monthly_forecast_extended of this ForecastObjectiveData.


        :param monthly_forecast_extended: The monthly_forecast_extended of this ForecastObjectiveData.  # noqa: E501
        :type: ForecastMonthlyForecasts
        """

        self._monthly_forecast_extended = monthly_forecast_extended
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastObjectiveData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastObjectiveData):
            return False
