...
class ForecastKeywordAdditionalTraffic(object):
    ...
    def __init__(self, sessions=None, sessions_best_target=None, conversions=None, conversions_best_target=None, revenue=None, revenue_best_target=None):  # noqa: E501
        """ForecastKeywordAdditionalTraffic - a model defined in Swagger"""  # noqa: E501
        self._sessions = None
    ...
    @property
    def sessions(self):
        """Gets the sessions of this ForecastKeywordAdditionalTraffic.  # noqa: E501

        The total estimated Additional Sessions for the keyword throughout the forecast timeframe, including the sessions from long tail keywords if the Long Tail Effect is enabled for the Scenario or Objective.  If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :return: The sessions of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :rtype: int
        """
    ...
    def sessions(self, sessions):
        """Sets the sessions of this ForecastKeywordAdditionalTraffic.

        The total estimated Additional Sessions for the keyword throughout the forecast timeframe, including the sessions from long tail keywords if the Long Tail Effect is enabled for the Scenario or Objective.  If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :param sessions: The sessions of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :type: int
        """
    ...
    def sessions_best_target(self):
        """Gets the sessions_best_target of this ForecastKeywordAdditionalTraffic.  # noqa: E501

        If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.  # noqa: E501

        :return: The sessions_best_target of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :rtype: int
        """
    ...
    def sessions_best_target(self, sessions_best_target):
        """Sets the sessions_best_target of this ForecastKeywordAdditionalTraffic.

        If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.  # noqa: E501

        :param sessions_best_target: The sessions_best_target of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :type: int
        """
    ...
    def conversions(self):
        """Gets the conversions of this ForecastKeywordAdditionalTraffic.  # noqa: E501

        The total estimated Additional Conversions for the keyword throughout the forecast timeframe, including the conversions from long tail keywords if the Long Tail Effect is enabled for the Scenario or Objective. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :return: The conversions of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :rtype: int
        """
    ...
    def conversions(self, conversions):
        """Sets the conversions of this ForecastKeywordAdditionalTraffic.

        The total estimated Additional Conversions for the keyword throughout the forecast timeframe, including the conversions from long tail keywords if the Long Tail Effect is enabled for the Scenario or Objective. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :param conversions: The conversions of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :type: int
        """
    ...
    def conversions_best_target(self):
        """Gets the conversions_best_target of this ForecastKeywordAdditionalTraffic.  # noqa: E501

        If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.  # noqa: E501

        :return: The conversions_best_target of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :rtype: int
        """
    ...
    def conversions_best_target(self, conversions_best_target):
        """Sets the conversions_best_target of this ForecastKeywordAdditionalTraffic.

        If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.  # noqa: E501

        :param conversions_best_target: The conversions_best_target of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :type: int
        """
    ...
    @property
    def revenue(self):
        """Gets the revenue of this ForecastKeywordAdditionalTraffic.  # noqa: E501

        The estimated Additional Revenue that would be achieved throughout the forecast timeframe, including the revenue from long tail keywords if the Long Tail Effect is enabled for the Scenario or Objective.  If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :return: The revenue of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :rtype: int
        """
    ...
    def revenue(self, revenue):
        """Sets the revenue of this ForecastKeywordAdditionalTraffic.

        The estimated Additional Revenue that would be achieved throughout the forecast timeframe, including the revenue from long tail keywords if the Long Tail Effect is enabled for the Scenario or Objective.  If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.  # noqa: E501

        :param revenue: The revenue of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :type: int
        """
    ...
    def revenue_best_target(self):
        """Gets the revenue_best_target of this ForecastKeywordAdditionalTraffic.  # noqa: E501

        If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.  # noqa: E501

        :return: The revenue_best_target of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :rtype: int
        """
    ...
    def revenue_best_target(self, revenue_best_target):
        """Sets the revenue_best_target of this ForecastKeywordAdditionalTraffic.

        If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.  # noqa: E501

        :param revenue_best_target: The revenue_best_target of this ForecastKeywordAdditionalTraffic.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastKeywordAdditionalTraffic, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastKeywordAdditionalTraffic):
            return False
