...
class GroupsDetailsKeywordsCounters(object):
    ...
    swagger_types = {
        'main_keywords': 'int',
        'close_variations': 'int'
    }

    attribute_map = {
        'main_keywords': 'main_keywords',
        'close_variations': 'close_variations'
    }

    def __init__(self, main_keywords=None, close_variations=None):  # noqa: E501
        """GroupsDetailsKeywordsCounters - a model defined in Swagger"""  # noqa: E501
        self._main_keywords = None
        self._close_variations = None
        self.discriminator = None
        if main_keywords is not None:
            self.main_keywords = main_keywords
        if close_variations is not None:
            self.close_variations = close_variations

    @property
    def main_keywords(self):
        """Gets the main_keywords of this GroupsDetailsKeywordsCounters.  # noqa: E501

        Group main keywords  # noqa: E501

        :return: The main_keywords of this GroupsDetailsKeywordsCounters.  # noqa: E501
        :rtype: int
        """
        return self._main_keywords

    @main_keywords.setter
    def main_keywords(self, main_keywords):
        """Sets the main_keywords of this GroupsDetailsKeywordsCounters.

        Group main keywords  # noqa: E501

        :param main_keywords: The main_keywords of this GroupsDetailsKeywordsCounters.  # noqa: E501
        :type: int
        """

        self._main_keywords = main_keywords

    @property
    def close_variations(self):
        """Gets the close_variations of this GroupsDetailsKeywordsCounters.  # noqa: E501

        Group keyword close variations  # noqa: E501

        :return: The close_variations of this GroupsDetailsKeywordsCounters.  # noqa: E501
        :rtype: int
        """
        return self._close_variations

    @close_variations.setter
    def close_variations(self, close_variations):
        """Sets the close_variations of this GroupsDetailsKeywordsCounters.

        Group keyword close variations  # noqa: E501

        :param close_variations: The close_variations of this GroupsDetailsKeywordsCounters.  # noqa: E501
        :type: int
        """

        self._close_variations = close_variations
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupsDetailsKeywordsCounters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupsDetailsKeywordsCounters):
            return False
