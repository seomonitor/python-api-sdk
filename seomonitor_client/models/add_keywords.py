...
class AddKeywords(object):
    ...
    def __init__(self, import_id=None):  # noqa: E501
        """AddKeywords - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def import_id(self):
        """Gets the import_id of this AddKeywords.  # noqa: E501

        The ID of the keyword import task that you can use to track the status of the import.   # noqa: E501

        :return: The import_id of this AddKeywords.  # noqa: E501
        :rtype: str
        """
    ...
    def import_id(self, import_id):
        """Sets the import_id of this AddKeywords.

        The ID of the keyword import task that you can use to track the status of the import.   # noqa: E501

        :param import_id: The import_id of this AddKeywords.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddKeywords, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddKeywords):
            return False
