...
class SerpFeaturePresence(object):
    ...
    swagger_types = {
        'keyword_id': 'int',
        'keyword': 'str',
        'serp_data': 'list[SerpFeaturePresenceSerpData]'
    }
    ...
    def __init__(self, keyword_id=None, keyword=None, serp_data=None):  # noqa: E501
        """SerpFeaturePresence - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def keyword_id(self):
        """Gets the keyword_id of this SerpFeaturePresence.  # noqa: E501
        ...
        :return: The keyword_id of this SerpFeaturePresence.  # noqa: E501
        :rtype: int
        """
    ...
    def keyword_id(self, keyword_id):
        """Sets the keyword_id of this SerpFeaturePresence.

        The unique ID used to identify and reference the keyword in the system. It can be stored and used in other endpoints for filtering.  # noqa: E501

        :param keyword_id: The keyword_id of this SerpFeaturePresence.  # noqa: E501
        :type: int
        """
    ...
    @property
    def keyword(self):
        """Gets the keyword of this SerpFeaturePresence.  # noqa: E501

        The name of the keyword.  # noqa: E501

        :return: The keyword of this SerpFeaturePresence.  # noqa: E501
        :rtype: str
        """
    ...
    def keyword(self, keyword):
        """Sets the keyword of this SerpFeaturePresence.

        The name of the keyword.  # noqa: E501

        :param keyword: The keyword of this SerpFeaturePresence.  # noqa: E501
        :type: str
        """
    ...
    @property
    def serp_data(self):
        """Gets the serp_data of this SerpFeaturePresence.  # noqa: E501

        Parent field containing the data for SERP features present on the keyword for each day of the selected timeframe, for each device.  Please refer to the Quick Start Guide for the complete feature name of each abbreviation.  # noqa: E501

        :return: The serp_data of this SerpFeaturePresence.  # noqa: E501
        :rtype: list[SerpFeaturePresenceSerpData]
        """
        return self._serp_data

    @serp_data.setter
    def serp_data(self, serp_data):
        """Sets the serp_data of this SerpFeaturePresence.

        Parent field containing the data for SERP features present on the keyword for each day of the selected timeframe, for each device.  Please refer to the Quick Start Guide for the complete feature name of each abbreviation.  # noqa: E501

        :param serp_data: The serp_data of this SerpFeaturePresence.  # noqa: E501
        :type: list[SerpFeaturePresenceSerpData]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SerpFeaturePresence, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SerpFeaturePresence):
            return False
