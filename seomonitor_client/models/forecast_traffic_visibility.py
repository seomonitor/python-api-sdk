...
class ForecastTrafficVisibility(object):
    ...
    def __init__(self, estimated=None, estimated_best_target=None):  # noqa: E501
        """ForecastTrafficVisibility - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def estimated(self):
        """Gets the estimated of this ForecastTrafficVisibility.  # noqa: E501

        The estimated Visibility.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.  # noqa: E501

        :return: The estimated of this ForecastTrafficVisibility.  # noqa: E501
        :rtype: float
        """
    ...
    def estimated(self, estimated):
        """Sets the estimated of this ForecastTrafficVisibility.

        The estimated Visibility.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.  # noqa: E501

        :param estimated: The estimated of this ForecastTrafficVisibility.  # noqa: E501
        :type: float
        """
    ...
    def estimated_best_target(self):
        """Gets the estimated_best_target of this ForecastTrafficVisibility.  # noqa: E501
        ...
        :return: The estimated_best_target of this ForecastTrafficVisibility.  # noqa: E501
        :rtype: int
        """
    ...
    def estimated_best_target(self, estimated_best_target):
        """Sets the estimated_best_target of this ForecastTrafficVisibility.

        If the `target_rank_range` parameter returns \"true\", this parameter returns the value calculated for the higher (best) target rank.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty.  # noqa: E501

        :param estimated_best_target: The estimated_best_target of this ForecastTrafficVisibility.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastTrafficVisibility, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastTrafficVisibility):
            return False
