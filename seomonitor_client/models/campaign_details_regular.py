...
class CampaignDetailsRegular(object):
    ...
    swagger_types = {
        ...
        'multiple_locations': 'list[object]',
        'health_status': 'str',
    ...
    def __init__(self, campaign_info=None, visibility=None, multiple_locations=None, health_status=None, objective_status=None, reporting_status=None, account_manager=None):  # noqa: E501
        """CampaignDetailsRegular - a model defined in Swagger"""  # noqa: E501
        self._campaign_info = None
        self._visibility = None
        self._multiple_locations = None
        self._health_status = None
        self._objective_status = None
        self._reporting_status = None
        ...
        if multiple_locations is not None:
            self.multiple_locations = multiple_locations
    ...
    def campaign_info(self):
        """Gets the campaign_info of this CampaignDetailsRegular.  # noqa: E501


        :return: The campaign_info of this CampaignDetailsRegular.  # noqa: E501
        :rtype: CampaignInfo
        """
        return self._campaign_info

    @campaign_info.setter
    def campaign_info(self, campaign_info):
        """Sets the campaign_info of this CampaignDetailsRegular.


        :param campaign_info: The campaign_info of this CampaignDetailsRegular.  # noqa: E501
        :type: CampaignInfo
        """
    ...
    @property
    def visibility(self):
        """Gets the visibility of this CampaignDetailsRegular.  # noqa: E501


        :return: The visibility of this CampaignDetailsRegular.  # noqa: E501
        :rtype: CampaignVisibility
        """
        return self._visibility

    @visibility.setter
    def visibility(self, visibility):
        """Sets the visibility of this CampaignDetailsRegular.


        :param visibility: The visibility of this CampaignDetailsRegular.  # noqa: E501
    ...
    def multiple_locations(self):
        """Gets the multiple_locations of this CampaignDetailsRegular.  # noqa: E501

        Parent field containing data for the additional tracked locations of the campaign.  # noqa: E501

        :return: The multiple_locations of this CampaignDetailsRegular.  # noqa: E501
        :rtype: list[object]
        """
        return self._multiple_locations

    @multiple_locations.setter
    def multiple_locations(self, multiple_locations):
        """Sets the multiple_locations of this CampaignDetailsRegular.

        Parent field containing data for the additional tracked locations of the campaign.  # noqa: E501

        :param multiple_locations: The multiple_locations of this CampaignDetailsRegular.  # noqa: E501
        :type: list[object]
        """

        self._multiple_locations = multiple_locations

    @property
    def health_status(self):
        """Gets the health_status of this CampaignDetailsRegular.  # noqa: E501

        The health status of the campaign.  Possible values: `poor`, `average`, `healthy`.   # noqa: E501

        :return: The health_status of this CampaignDetailsRegular.  # noqa: E501
        :rtype: str
        """
    ...
    def health_status(self, health_status):
        """Sets the health_status of this CampaignDetailsRegular.

        The health status of the campaign.  Possible values: `poor`, `average`, `healthy`.   # noqa: E501

        :param health_status: The health_status of this CampaignDetailsRegular.  # noqa: E501
        :type: str
        """
    ...
    def objective_status(self):
        """Gets the objective_status of this CampaignDetailsRegular.  # noqa: E501


        :return: The objective_status of this CampaignDetailsRegular.  # noqa: E501
        :rtype: Objective
        """
    ...
    def objective_status(self, objective_status):
        """Sets the objective_status of this CampaignDetailsRegular.


        :param objective_status: The objective_status of this CampaignDetailsRegular.  # noqa: E501
        :type: Objective
        """
    ...
    def reporting_status(self):
        """Gets the reporting_status of this CampaignDetailsRegular.  # noqa: E501

        The reporting status for the current month.  Possible values:   `pending`: The default status of the report at the beginning of the month.  `overdue`: If the report is not submitted by the due date set.  `in_progress`: If someone started working on the report in Google Slides.  `submitted`: If the report has been uploaded or finalized in Google Slides.  `inactive`: If the report tracking is turned off for the campaign.   # noqa: E501

        :return: The reporting_status of this CampaignDetailsRegular.  # noqa: E501
        :rtype: str
        """
        return self._reporting_status

    @reporting_status.setter
    def reporting_status(self, reporting_status):
        """Sets the reporting_status of this CampaignDetailsRegular.

        The reporting status for the current month.  Possible values:   `pending`: The default status of the report at the beginning of the month.  `overdue`: If the report is not submitted by the due date set.  `in_progress`: If someone started working on the report in Google Slides.  `submitted`: If the report has been uploaded or finalized in Google Slides.  `inactive`: If the report tracking is turned off for the campaign.   # noqa: E501

        :param reporting_status: The reporting_status of this CampaignDetailsRegular.  # noqa: E501
        :type: str
        """
    ...
    def account_manager(self):
        """Gets the account_manager of this CampaignDetailsRegular.  # noqa: E501

        The first and last name of the user assigned as the Account Manager of the campaign.  # noqa: E501

        :return: The account_manager of this CampaignDetailsRegular.  # noqa: E501
        :rtype: str
        """
    ...
    def account_manager(self, account_manager):
        """Sets the account_manager of this CampaignDetailsRegular.

        The first and last name of the user assigned as the Account Manager of the campaign.  # noqa: E501

        :param account_manager: The account_manager of this CampaignDetailsRegular.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CampaignDetailsRegular, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignDetailsRegular):
            return False
