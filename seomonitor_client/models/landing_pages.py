...
class LandingPages(object):
    ...
    def __init__(self, current=None, desired=None):  # noqa: E501
        """LandingPages - a model defined in Swagger"""  # noqa: E501
        self._current = None
        self._desired = None
    ...
    @property
    def current(self):
        """Gets the current of this LandingPages.  # noqa: E501

        The landing page that is currently ranking for the keyword on Google searches performed from mobile devices.  # noqa: E501

        :return: The current of this LandingPages.  # noqa: E501
        :rtype: str
        """
    ...
    def current(self, current):
        """Sets the current of this LandingPages.

        The landing page that is currently ranking for the keyword on Google searches performed from mobile devices.  # noqa: E501

        :param current: The current of this LandingPages.  # noqa: E501
        :type: str
        """
    ...
    @property
    def desired(self):
        """Gets the desired of this LandingPages.  # noqa: E501

        The landing page you target to rank with on Google searches performed from mobile devices.  # noqa: E501

        :return: The desired of this LandingPages.  # noqa: E501
        :rtype: str
        """
    ...
    def desired(self, desired):
        """Sets the desired of this LandingPages.

        The landing page you target to rank with on Google searches performed from mobile devices.  # noqa: E501

        :param desired: The desired of this LandingPages.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LandingPages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LandingPages):
            return False
