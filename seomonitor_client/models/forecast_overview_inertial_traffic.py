...
class ForecastOverviewInertialTraffic(object):
    ...
    def __init__(self, sessions=None, conversions=None, revenue=None):  # noqa: E501
        """ForecastOverviewInertialTraffic - a model defined in Swagger"""  # noqa: E501
        self._sessions = None
    ...
    @property
    def sessions(self):
        """Gets the sessions of this ForecastOverviewInertialTraffic.  # noqa: E501

        The estimated Inertial Non-Brand Organic Sessions that would be achieved throughout the forecast timeframe if the ranks remained the same as the current ranks, plotted on the search trends.  # noqa: E501

        :return: The sessions of this ForecastOverviewInertialTraffic.  # noqa: E501
        :rtype: int
        """
    ...
    def sessions(self, sessions):
        """Sets the sessions of this ForecastOverviewInertialTraffic.

        The estimated Inertial Non-Brand Organic Sessions that would be achieved throughout the forecast timeframe if the ranks remained the same as the current ranks, plotted on the search trends.  # noqa: E501

        :param sessions: The sessions of this ForecastOverviewInertialTraffic.  # noqa: E501
        :type: int
        """
    ...
    def conversions(self):
        """Gets the conversions of this ForecastOverviewInertialTraffic.  # noqa: E501

        The estimated Inertial Non-Brand Organic Conversions that would be achieved throughout the forecast timeframe if the ranks remained the same as the current ranks.  # noqa: E501

        :return: The conversions of this ForecastOverviewInertialTraffic.  # noqa: E501
        :rtype: int
        """
    ...
    def conversions(self, conversions):
        """Sets the conversions of this ForecastOverviewInertialTraffic.

        The estimated Inertial Non-Brand Organic Conversions that would be achieved throughout the forecast timeframe if the ranks remained the same as the current ranks.  # noqa: E501

        :param conversions: The conversions of this ForecastOverviewInertialTraffic.  # noqa: E501
        :type: int
        """
    ...
    @property
    def revenue(self):
        """Gets the revenue of this ForecastOverviewInertialTraffic.  # noqa: E501

        The estimated Inertial Non-Brand Organic Revenue that would be achieved throughout the forecast timeframe if the ranks remained the same as the current ranks.  # noqa: E501

        :return: The revenue of this ForecastOverviewInertialTraffic.  # noqa: E501
        :rtype: int
        """
    ...
    def revenue(self, revenue):
        """Sets the revenue of this ForecastOverviewInertialTraffic.

        The estimated Inertial Non-Brand Organic Revenue that would be achieved throughout the forecast timeframe if the ranks remained the same as the current ranks.  # noqa: E501

        :param revenue: The revenue of this ForecastOverviewInertialTraffic.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastOverviewInertialTraffic, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastOverviewInertialTraffic):
            return False
