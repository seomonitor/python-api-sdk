...
class DifficultyValue(object):
    ...
    def __init__(self, text=None, value=None, top_10=None):  # noqa: E501
        """DifficultyValue - a model defined in Swagger"""  # noqa: E501
        self._text = None
        self._value = None
        self._top_10 = None
    ...
    @property
    def text(self):
        """Gets the text of this DifficultyValue.  # noqa: E501

        Difficulty value as text. Available values are: Top10 => Already in top; Easy => Easy difficulty; Medium => Medium difficulty; Hard => Hard difficulty;  # noqa: E501

        :return: The text of this DifficultyValue.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this DifficultyValue.

        Difficulty value as text. Available values are: Top10 => Already in top; Easy => Easy difficulty; Medium => Medium difficulty; Hard => Hard difficulty;  # noqa: E501

        :param text: The text of this DifficultyValue.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this DifficultyValue.  # noqa: E501

        Difficulty value as an integer. Available values are: 0 => Already in top; 1 => Easy; 2 => Medium; 3 => Hard;  # noqa: E501

        :return: The value of this DifficultyValue.  # noqa: E501
        :rtype: int
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this DifficultyValue.

        Difficulty value as an integer. Available values are: 0 => Already in top; 1 => Easy; 2 => Medium; 3 => Hard;  # noqa: E501

        :param value: The value of this DifficultyValue.  # noqa: E501
        :type: int
        """
    ...
    @property
    def top_10(self):
        """Gets the top_10 of this DifficultyValue.  # noqa: E501

        Boolean value on whether the keyword is already in top 10 or not;  # noqa: E501

        :return: The top_10 of this DifficultyValue.  # noqa: E501
        :rtype: bool
        """
        return self._top_10

    @top_10.setter
    def top_10(self, top_10):
        """Sets the top_10 of this DifficultyValue.

        Boolean value on whether the keyword is already in top 10 or not;  # noqa: E501

        :param top_10: The top_10 of this DifficultyValue.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DifficultyValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DifficultyValue):
            return False
