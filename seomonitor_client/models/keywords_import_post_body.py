...
class KeywordsImportPostBody(object):
    ...
    def __init__(self, campaign_id=None, keywords=None, group_ids=None):  # noqa: E501
        """KeywordsImportPostBody - a model defined in Swagger"""  # noqa: E501
    ...
    def campaign_id(self):
        """Gets the campaign_id of this KeywordsImportPostBody.  # noqa: E501

        The ID of the campaign to which you want to add/import keywords.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns.  # noqa: E501

        :return: The campaign_id of this KeywordsImportPostBody.  # noqa: E501
        :rtype: int
        """
    ...
    def campaign_id(self, campaign_id):
        """Sets the campaign_id of this KeywordsImportPostBody.

        The ID of the campaign to which you want to add/import keywords.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns.  # noqa: E501

        :param campaign_id: The campaign_id of this KeywordsImportPostBody.  # noqa: E501
        :type: int
        """
    ...
    @property
    def keywords(self):
        """Gets the keywords of this KeywordsImportPostBody.  # noqa: E501

        A comma-separated list of new keywords that you want to import into the campaign. E.g. `\"christmas party dresses, christmas sweater, christmas jumpers\"`.  Please refer to the Quick Start Guide to learn how to retrieve the IDs of your keywords.  # noqa: E501

        :return: The keywords of this KeywordsImportPostBody.  # noqa: E501
        :rtype: str
        """
    ...
    def keywords(self, keywords):
        """Sets the keywords of this KeywordsImportPostBody.

        A comma-separated list of new keywords that you want to import into the campaign. E.g. `\"christmas party dresses, christmas sweater, christmas jumpers\"`.  Please refer to the Quick Start Guide to learn how to retrieve the IDs of your keywords.  # noqa: E501

        :param keywords: The keywords of this KeywordsImportPostBody.  # noqa: E501
        :type: str
        """
    ...
    def group_ids(self, group_ids):
        """Sets the group_ids of this KeywordsImportPostBody.

        A comma-separated list of group IDs into which you want to import the keywords. E.g. `\"199212, 1237564\"`.  Please refer to the Quick Start Guide to learn how to retrieve the IDs of your groups.  If you don't specify `group_ids`, the keywords will be added to an automatically-generated group (`API-import-YYYY-MM-DD`).  # noqa: E501

        :param group_ids: The group_ids of this KeywordsImportPostBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KeywordsImportPostBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeywordsImportPostBody):
            return False
