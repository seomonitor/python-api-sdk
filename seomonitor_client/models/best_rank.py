...
class BestRank(object):
    ...
    def __init__(self, rank=None, _date=None):  # noqa: E501
        """BestRank - a model defined in Swagger"""  # noqa: E501
        self._rank = None
        self.__date = None
    ...
    @property
    def rank(self):
        """Gets the rank of this BestRank.  # noqa: E501

        The highest position the keyword ranked on Google since it was tracked in the app.  # noqa: E501

        :return: The rank of this BestRank.  # noqa: E501
        :rtype: int
        """
        return self._rank
    ...
    @rank.setter
    def rank(self, rank):
        """Sets the rank of this BestRank.

        The highest position the keyword ranked on Google since it was tracked in the app.  # noqa: E501

        :param rank: The rank of this BestRank.  # noqa: E501
        :type: int
        """
    ...
    @property
    def _date(self):
        """Gets the _date of this BestRank.  # noqa: E501

        The latest date when the keyword reached the highest position on Google since it was tracked in the app, for desktop devices.  # noqa: E501

        :return: The _date of this BestRank.  # noqa: E501
        :rtype: date
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this BestRank.

        The latest date when the keyword reached the highest position on Google since it was tracked in the app, for desktop devices.  # noqa: E501

        :param _date: The _date of this BestRank.  # noqa: E501
        :type: date
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BestRank):
            return False
