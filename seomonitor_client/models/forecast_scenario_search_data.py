...
class ForecastScenarioSearchData(object):
    ...
    swagger_types = {
        ...
        'monthly_searches': 'list[MonthlySearches]',
        'volume_by_device': 'GroupsVolumeByDevice',
    ...
    attribute_map = {
        ...
        'volume_by_device': 'volume_by_device',
        'percentage_clicks': 'percentage_clicks'
    }

    def __init__(self, search_volume=None, year_over_year=None, monthly_searches=None, volume_by_device=None, percentage_clicks=None):  # noqa: E501
        """ForecastScenarioSearchData - a model defined in Swagger"""  # noqa: E501
        self._search_volume = None
        self._year_over_year = None
        self._monthly_searches = None
        self._volume_by_device = None
        ...
        if volume_by_device is not None:
            self.volume_by_device = volume_by_device
        if percentage_clicks is not None:
            self.percentage_clicks = percentage_clicks

    @property
    def search_volume(self):
        """Gets the search_volume of this ForecastScenarioSearchData.  # noqa: E501

        The average 12-month search volume of the keywords included in the scenario, as provided by Google Ads.  # noqa: E501

        :return: The search_volume of this ForecastScenarioSearchData.  # noqa: E501
        :rtype: int
        """
    ...
    def search_volume(self, search_volume):
        """Sets the search_volume of this ForecastScenarioSearchData.

        The average 12-month search volume of the keywords included in the scenario, as provided by Google Ads.  # noqa: E501

        :param search_volume: The search_volume of this ForecastScenarioSearchData.  # noqa: E501
        :type: int
        """
    ...
    def year_over_year(self):
        """Gets the year_over_year of this ForecastScenarioSearchData.  # noqa: E501

        A numeric value representing the last month's search volume divided by the search volume of the same month of the previous year. E.g. +27% year-over-year search trend would be represented as 1.27.  The returned values will be capped at 10, which represents \"newcomers\" (keywords that registered very low search volumes in the previous year).  # noqa: E501

        :return: The year_over_year of this ForecastScenarioSearchData.  # noqa: E501
        :rtype: float
        """
    ...
    def year_over_year(self, year_over_year):
        """Sets the year_over_year of this ForecastScenarioSearchData.

        A numeric value representing the last month's search volume divided by the search volume of the same month of the previous year. E.g. +27% year-over-year search trend would be represented as 1.27.  The returned values will be capped at 10, which represents \"newcomers\" (keywords that registered very low search volumes in the previous year).  # noqa: E501

        :param year_over_year: The year_over_year of this ForecastScenarioSearchData.  # noqa: E501
        :type: float
        """
    ...
    def monthly_searches(self):
        """Gets the monthly_searches of this ForecastScenarioSearchData.  # noqa: E501

        An array of objects containing the average search volumes for each of the previous 13 months for the keywords included in the scenario, as provided by Google Ads.  # noqa: E501

        :return: The monthly_searches of this ForecastScenarioSearchData.  # noqa: E501
        :rtype: list[MonthlySearches]
        """
        return self._monthly_searches

    @monthly_searches.setter
    def monthly_searches(self, monthly_searches):
        """Sets the monthly_searches of this ForecastScenarioSearchData.

        An array of objects containing the average search volumes for each of the previous 13 months for the keywords included in the scenario, as provided by Google Ads.  # noqa: E501

        :param monthly_searches: The monthly_searches of this ForecastScenarioSearchData.  # noqa: E501
        :type: list[MonthlySearches]
        """

        self._monthly_searches = monthly_searches

    @property
    def volume_by_device(self):
        """Gets the volume_by_device of this ForecastScenarioSearchData.  # noqa: E501


        :return: The volume_by_device of this ForecastScenarioSearchData.  # noqa: E501
        :rtype: GroupsVolumeByDevice
        """
        return self._volume_by_device

    @volume_by_device.setter
    def volume_by_device(self, volume_by_device):
        """Sets the volume_by_device of this ForecastScenarioSearchData.


        :param volume_by_device: The volume_by_device of this ForecastScenarioSearchData.  # noqa: E501
        :type: GroupsVolumeByDevice
        """

        self._volume_by_device = volume_by_device

    @property
    def percentage_clicks(self):
        """Gets the percentage_clicks of this ForecastScenarioSearchData.  # noqa: E501
        ...
        :return: The percentage_clicks of this ForecastScenarioSearchData.  # noqa: E501
        :rtype: float
        """
    ...
    def percentage_clicks(self, percentage_clicks):
        """Sets the percentage_clicks of this ForecastScenarioSearchData.

        The percentage of searches that end up clicking on organic results, after discounting the searches satisfied by SERP features. Blended metric between desktop and mobile searches.  # noqa: E501

        :param percentage_clicks: The percentage_clicks of this ForecastScenarioSearchData.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastScenarioSearchData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastScenarioSearchData):
            return False
