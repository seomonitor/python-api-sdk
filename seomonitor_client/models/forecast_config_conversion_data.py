...
class ForecastConfigConversionData(object):
    ...
    def __init__(self, conversion_rate=None, avg_order_value=None):  # noqa: E501
        """ForecastConfigConversionData - a model defined in Swagger"""  # noqa: E501
        self._conversion_rate = None
        self._avg_order_value = None
    ...
    def conversion_rate(self):
        """Gets the conversion_rate of this ForecastConfigConversionData.  # noqa: E501

        The average Conversion Rate of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Conversions as the multiplier of Additional Sessions.  # noqa: E501

        :return: The conversion_rate of this ForecastConfigConversionData.  # noqa: E501
        :rtype: float
        """
    ...
    def conversion_rate(self, conversion_rate):
        """Sets the conversion_rate of this ForecastConfigConversionData.

        The average Conversion Rate of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Conversions as the multiplier of Additional Sessions.  # noqa: E501

        :param conversion_rate: The conversion_rate of this ForecastConfigConversionData.  # noqa: E501
        :type: float
        """
    ...
    def avg_order_value(self):
        """Gets the avg_order_value of this ForecastConfigConversionData.  # noqa: E501

        The Average Order Value of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Revenue as the multiplier of Additional Conversions.  # noqa: E501

        :return: The avg_order_value of this ForecastConfigConversionData.  # noqa: E501
        :rtype: float
        """
        return self._avg_order_value

    @avg_order_value.setter
    def avg_order_value(self, avg_order_value):
        """Sets the avg_order_value of this ForecastConfigConversionData.

        The Average Order Value of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Revenue as the multiplier of Additional Conversions.  # noqa: E501

        :param avg_order_value: The avg_order_value of this ForecastConfigConversionData.  # noqa: E501
        :type: float
        """

        self._avg_order_value = avg_order_value
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastConfigConversionData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastConfigConversionData):
            return False
