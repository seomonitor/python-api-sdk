...
class AddCampaignPostBody(object):
    ...
    def __init__(self, campaign_url=None, location_code=None, company_id=None):  # noqa: E501
        """AddCampaignPostBody - a model defined in Swagger"""  # noqa: E501
    ...
    def campaign_url(self):
        """Gets the campaign_url of this AddCampaignPostBody.  # noqa: E501

        The domain of the campaign you want to add.  # noqa: E501

        :return: The campaign_url of this AddCampaignPostBody.  # noqa: E501
        :rtype: str
        """
    ...
    def campaign_url(self, campaign_url):
        """Sets the campaign_url of this AddCampaignPostBody.

        The domain of the campaign you want to add.  # noqa: E501

        :param campaign_url: The campaign_url of this AddCampaignPostBody.  # noqa: E501
        :type: str
        """
    ...
    def location_code(self):
        """Gets the location_code of this AddCampaignPostBody.  # noqa: E501

        The location code for the campaign you want to add. This can be obtained by calling the Get Locations endpoint (/campaign-management/v3.0/locations).  # noqa: E501

        :return: The location_code of this AddCampaignPostBody.  # noqa: E501
        :rtype: str
        """
    ...
    def location_code(self, location_code):
        """Sets the location_code of this AddCampaignPostBody.

        The location code for the campaign you want to add. This can be obtained by calling the Get Locations endpoint (/campaign-management/v3.0/locations).  # noqa: E501

        :param location_code: The location_code of this AddCampaignPostBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def company_id(self):
        """Gets the company_id of this AddCampaignPostBody.  # noqa: E501

        The id of the company where the campaign will be added. Required only if user has access to multiple companies.  # noqa: E501

        :return: The company_id of this AddCampaignPostBody.  # noqa: E501
        :rtype: int
        """
    ...
    def company_id(self, company_id):
        """Sets the company_id of this AddCampaignPostBody.

        The id of the company where the campaign will be added. Required only if user has access to multiple companies.  # noqa: E501

        :param company_id: The company_id of this AddCampaignPostBody.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddCampaignPostBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddCampaignPostBody):
            return False
